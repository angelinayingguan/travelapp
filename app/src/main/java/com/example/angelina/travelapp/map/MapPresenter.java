...
import com.example.angelina.travelapp.data.LocationService;
import com.example.angelina.travelapp.data.Place;
import com.example.angelina.travelapp.data.PlacesServiceApi;
    ...
    if ((mCenteredPlace != null) && (mLocationService.getCurrentLocation() != null)){
      ...
      mLocationService.getRouteFromService(mLocationService.getCurrentLocation(), mCenteredPlace.getLocation(),
          new PlacesServiceApi.RouteServiceCallback() {
            @Override
            public void onRouteReturned(final RouteResult result) {

 ...
 *
 */
package com.example.angelina.travelapp.data;
...
public class LocationService implements PlacesServiceApi {
  ...
  @Override
  public void getRouteFromService(final Point start, final Point end, final RouteServiceCallback callback) {
  ...
  @Override
  public Place getPlaceDetail(final String placeName) {

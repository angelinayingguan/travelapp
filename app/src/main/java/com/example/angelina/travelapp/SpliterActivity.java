...
public class SpliterActivity extends AppCompatActivity implements Serializable{

    ArrayList<SplitItem> mealItems;
    ArrayList<com.example.angelina.travelapp.Person> guests;
    ImageView plateIcon;
...
//        }
    ...
    public void setUpIcons() {
        ...
        for(int x=0; x < guests.size(); x++) {
            ...
            final Button guestName = new Button(SpliterActivity.this);
            ...
            guestName.setOnClickListener(new View.OnClickListener() {
                public void onClick(View view){
                    ...
                    intent = new Intent(SpliterActivity.this, UserSummary.class);
